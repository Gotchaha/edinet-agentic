"""Run EXP-A-0003 ReAct agent with calculator tool.

Usage:
    uv run python scripts/EXP-A-0003/run.py --config configs/EXP-A-0003.yaml
    uv run python scripts/EXP-A-0003/run.py --config configs/EXP-A-0003.yaml --limit 1
"""
